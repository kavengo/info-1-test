...
class Task1TestNoPromotion(TestCase):
    """
    Task 1: Test case with no promotion (promotion = 0)
    """
    ...
    def test_savings(self):
        """No Promotion - Test savings """
        self.assertTrue(hasattr(self.exercise, "savings"), "You must declare 'savings'")
        self.assertEqual(self.exercise.savings, 0, "'savings' value seems wrong")

    def test_total_price(self):
        """No Promotion - Test total price """
        self.assertTrue(hasattr(self.exercise, "total_price"), "You must declare 'total_price'")
        self.assertEqual(self.exercise.total_price, 10, "'savings' value seems wrong")
...
class Task1Test20Percent(TestCase):
    """
...
class Task1Test100Percent(TestCase):
    """
    Task 1: Test case with 100% promotion (promotion = 100)
    """
    ...
    def test_subtotal(self):
        """100% Promotion - Test subtotal """
        self.assertTrue(hasattr(self.exercise, "subtotal_price"), "You must declare 'subtotal_price'")
        self.assertEqual(self.exercise.subtotal_price, 10, "'subtotal_price' value seems wrong")

    def test_savings(self):
        """100% Promotion - Test savings """
        self.assertTrue(hasattr(self.exercise, "savings"), "You must declare 'savings'")
        self.assertEqual(self.exercise.savings, 10, "'savings' value seems wrong")

    def test_total_price(self):
        """100% Promotion - Test total price """
        self.assertTrue(hasattr(self.exercise, "total_price"), "You must declare 'total_price'")
        self.assertEqual(self.exercise.total_price, 0, "'total_price' value seems wrong")
